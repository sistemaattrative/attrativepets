<?php
session_start();
$_SESSION[cpf_cliente] = $_POST[login];
?>
			...
			<section id="main" class="wrapper">
				<div class="inner">
					<div class="content">
						...
						<br>
						<div align=center>
							<a href='/pdfDB/index.php' class="button primary fit small" style="background-color:blue;width:30%;">Baixar PDF da Proposta de Adesão</a>
						</div>
						<br>
						<div align=center>
